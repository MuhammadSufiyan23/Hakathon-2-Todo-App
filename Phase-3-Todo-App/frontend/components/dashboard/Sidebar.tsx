...
export function Sidebar() {
  return (
    <motion.div
      className="flex h-full flex-col px-4 py-6 bg-muted/10"
      initial="hidden"
      animate="visible"
      variants={slideInFromLeft}
    >
      <div className="mb-8">
        <h2 className="text-xl font-bold text-foreground">Todo Dashboard</h2>
      </div>
      ...
      <nav className="flex flex-1 flex-col gap-2">
        ...
        <Button
          variant="default"
          className="justify-start px-3 py-2 mb-6"
          asChild
        >
          <Link href="/tasks/new">
